...
if args.loss_per_batch:
    ...
    model_training.train_each_model(args.savedir, device, X_train, X_val, y_train, y_val, model_nums=collect_model_num, l1=l1, l2=l2, l3=l3, use_SGD=args.sgd, momentum=args.momentum, weight_seed=args.weight_seed, morelayers=args.morelayers, hingeloss=args.hingeloss, dropout=args.dropout, num_model=args.num_model, signal_vs_bg=args.signal_vs_bg, data_reduc=args.data_reduc, phi=args.phi, gauss_num=args.gaussian, uniform_num=args.uniform, learning_rate=learning_rate, weight_decay=args.weight_decay, epochs=epochs, batch_size=batch_size)
else:
