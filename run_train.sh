...
#SBATCH --nodes=1
#SBATCH --job-name 2Gallparam        # give job unique name
...
# run
python run_training.py --savedir 2Gallhyperparam/ --gaussian 2 --nodes 512 512 512 --learning_rate 2e-3 --batch_size 16
